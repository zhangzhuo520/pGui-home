...
void MainWindow::initToolbar()
{
    ...
    mouseAction = new QAction(QIcon(":/dfjy/images/mouse.png"), "Pen" ,this);
    ...
    connect (colorBtn, SIGNAL(clicked()), this, SLOT(ShowColor()), Qt::UniqueConnection);
...
void MainWindow::slot_click_fileItem(QModelIndex index)
{
    ...
    if (modelIdexList.isEmpty())
    {
        ...
        paintWidget->setStyleSheet("background-color: rgb(255, 255, 255);");
        paintTab->addTab(paintWidget,currentFile);
    }
    else
    {
