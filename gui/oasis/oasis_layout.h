...
public:
    ...
    int32 count_mark(int64 top_index, 
    ...
    void draw_bitmap(int64 infoindex,
...
//                     std::map<LDType, int>& ld_map,
    ...
    uint64 imported_element_count();
    void change_imported_element_count(int64 count);
    void smart_clean_cache(int64 cache_limit, int64 expire_limit, int64 cycle_limit);
...
private:
    ...
    std::unordered_map<int64, OasisCellInfo> m_cellinfos;
    std::unordered_map<uint64, OasisCell*> m_cells;
    ...
    sys::Mutex m_element_count_locker;
    int64 m_element_count;
